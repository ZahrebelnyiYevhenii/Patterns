...
public class DescriptionSushiBuilder implements SushiBuilder {
    ...
    public DescriptionSushi getSushi() {
        return new DescriptionSushi(sushiType, noriType, riceType, fishType, avocadoType, cheeseType);
    }
}
